<!-- File: resources/views/layouts/pembina.blade.php -->
...
<head>
    ...
    <title>@yield('title') - Pembina Sistem Ekstrakurikuler</title>
    ...
    <div class="container-scroller">
        ...
        <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="navbar-brand brand-logo" href="{{ route('pembina.dashboard') }}">
                    <span class="font-weight-bold">EKSKUL PEMBINA</span>
                </a>
                <a class="navbar-brand brand-logo-mini" href="{{ route('pembina.dashboard') }}">
                    <span class="font-weight-bold">EP</span>
                </a>
            </div>
                ...
                <ul class="navbar-nav navbar-nav-right">
                    <li class="nav-item nav-profile dropdown">
                        ...
                        <div class="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">
                            <a class="dropdown-item" href="{{ route('pembina.profile') }}">
                                <i class="mdi mdi-account me-2 text-success"></i> Profil
                            </a>
                        ...
                        <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list"
                            ...
                            <a class="dropdown-item preview-item">
                                ...
                                <div
                                    ...
                                    <h6 class="preview-subject font-weight-normal mb-1">Pertemuan Hari Ini</h6>
                                    <p class="text-gray ellipsis mb-0">Pelatihan basket 15:00 WIB</p>
                                </div>
                            </a>
                            <div class="dropdown-divider"></div>
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    <li class="nav-item nav-profile">
                        <a href="#" class="nav-link">
                            ...
                            <div class="nav-profile-text d-flex flex-column">
                                ...
                                <span class="text-secondary text-small">Pembina Ekstrakurikuler</span>
                            </div>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('pembina.extracurriculars.index') }}">
                            <span class="menu-title">Kelola Ekstrakurikuler</span>
                            <i class="mdi mdi-school menu-icon"></i>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('pembina.enrollments.index') }}">
                            <span class="menu-title">Kelola Pendaftaran</span>
                            <i class="mdi mdi-account-check menu-icon"></i>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('pembina.meetings.index') }}">
                            <span class="menu-title">Kelola Pertemuan</span>
                            <i class="mdi mdi-calendar menu-icon"></i>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('pembina.attendances.index') }}">
                            <span class="menu-title">Kelola Kehadiran</span>
                            <i class="mdi mdi-clipboard-check menu-icon"></i>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('pembina.achievements.index') }}">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="laporan-menu">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('pembina.reports.attendance') }}">Laporan
                                        Kehadiran</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('pembina.reports.achievements') }}">Laporan
                                        Prestasi</a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('pembina.profile') }}">
