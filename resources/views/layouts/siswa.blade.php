...
<body class="sb-nav-fixed">
    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand -->
        <a class="navbar-brand ps-3" href="{{ route('siswa.dashboard') }}">
        ...
        <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                    <li><a class="dropdown-item" href="{{ route('siswa.profile') }}"><i
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link {{ request()->routeIs('siswa.recommendations.*') ? 'active' : '' }}"
                            href="{{ route('siswa.recommendations.show') }}">
                            <div class="sb-nav-link-icon"><i class="fas fa-lightbulb"></i></div>
                            Rekomendasi
                        </a>
                        <a class="nav-link {{ request()->routeIs('siswa.enrollments.*') ? 'active' : '' }}"
                            href="{{ route('siswa.enrollments.index') }}">
                            <div class="sb-nav-link-icon"><i class="fas fa-users-class"></i></div>
                            Ekstrakurikuler Saya
                        </a>
                        <a class="nav-link {{ request()->routeIs('siswa.schedule') ? 'active' : '' }}"
                            href="{{ route('siswa.schedule') }}">
                            <div class="sb-nav-link-icon"><i class="fas fa-calendar-alt"></i></div>
                            Jadwal Kegiatan
                        </a>
                        <a class="nav-link {{ request()->routeIs('siswa.achievements') ? 'active' : '' }}"
                            href="{{ route('siswa.achievements') }}">
